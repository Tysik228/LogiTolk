...
class RegisterWindow(CTk):
    def __init__(self):
        ...
        self.title("Регестрація")
        self.username = None
        self.label = CTkLabel(self,text="Вхід в LogiTalk",font = ("Arial",20,"bold"))
        self.label.pack(pady=40)

        self.name_entry = CTkEntry(self,placeholder_text="Ведіть ім'я")
        self.name_entry.pack()

        self.host_entry = CTkEntry(self,placeholder_text="Ведіть хост")
        self.host_entry.pack()

        self.port_entry = CTkEntry(self,placeholder_text="Ведіть порт")
    ...
    def start_chat(self):
        ...
        try:
            ...
            self.sock.connect((self.host_entry.get(),int(self.port_entry.get(),8080)))
